...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password) || empty($confirm_password)) {
        ...
        // Simpan data pengguna (contoh sederhana, sebaiknya gunakan database)
        // Di sini kita hanya menampilkan pesan sukses
        $_SESSION['registration_success'] = 'Pendaftaran berhasil! Silakan login dengan akun Anda.';
...
<head>
    ...
    <title>Daftar Akun - StockFlow</title>
...
<body>
    <div class="register-container">
        <div class="register-header">
            ...
            <p>Daftar untuk mengakses sistem manajemen stok barang</p>
        </div>
        ...
        <form method="POST" action="" class="register-form">
            ...
            <div class="register-footer">
                Sudah punya akun? <a href="index.php?page=auth/login">Masuk disini</a>
            </div>
        </form>
    </div>
</body>
